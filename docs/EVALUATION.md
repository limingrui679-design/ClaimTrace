...
`npm run test:coverage` instruments `src/core` and enforces minimums of 95% statements, 95% lines, 95% functions, and 75% branches. The 2026-08-11 release run reports 96.99% statements/lines, 99.37% functions, and 78.75% branches. CI uploads the HTML and LCOV report as a short-lived artifact.
