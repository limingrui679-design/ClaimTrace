...
|---|---|
| `npm run ci` | Passed |
| Unit and integration tests | 142/142 passed |
...
| Core statement and line coverage | 97.20% |
| Core function coverage | 99.33% |
| Core branch coverage | 78.63% |
