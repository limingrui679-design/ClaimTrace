...
| Core statement and line coverage | 97.19% |
| Core function coverage | 99.33% |
| Core branch coverage | 78.47% |
...
| Source-refresh consistency, locking, recovery, and failure-path tests | 24/24 passed |
