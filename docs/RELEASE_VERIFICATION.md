...
|---|---|
| `npm run ci` | Passed |
| Unit and integration tests | 130/130 passed |
...
| Source-refresh consistency, locking, recovery, and failure-path tests | 14/14 passed |
