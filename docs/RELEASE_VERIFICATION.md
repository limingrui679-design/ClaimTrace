...
|---|---|
| `npm run ci` | Passed |
| Unit and integration tests | 122/122 passed |
...
| Source-refresh consistency and failure-path tests | 6/6 passed |
