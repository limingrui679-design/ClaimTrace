...
`npm run ci` must finish with generated fixtures unchanged, 143 passing unit/integration tests, one passing Chromium acceptance test, 64/64 benchmark labels, 512 deterministic property trials, and coverage above the committed thresholds.
