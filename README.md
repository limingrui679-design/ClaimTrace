...
`npm run ci` runs lint, TypeScript checking, deterministic fixture generation, the benchmark, a production build, 138 unit/integration tests, one real-Chromium read-only acceptance test, and coverage thresholds.
...
- **139 / 139 automated tests** — 138 unit/integration tests plus 1 real-Chromium read-only acceptance test
