...
`npm run ci` runs lint, TypeScript checking, deterministic fixture generation, the benchmark, a production build, 142 unit/integration tests, one real-Chromium read-only acceptance test, and coverage thresholds.
...
- **143 / 143 automated tests** — 142 unit/integration tests plus 1 real-Chromium read-only acceptance test
...
- **97.20% statement/line coverage, 78.63% branch coverage, 99.33% function coverage** for `src/core`
