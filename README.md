...
`npm run ci` runs lint, TypeScript checking, deterministic fixture generation, the benchmark, a production build, 141 unit/integration tests, one real-Chromium read-only acceptance test, and coverage thresholds.
...
- **142 / 142 automated tests** — 141 unit/integration tests plus 1 real-Chromium read-only acceptance test
...
- **97.19% statement/line coverage, 78.47% branch coverage, 99.33% function coverage** for `src/core`
