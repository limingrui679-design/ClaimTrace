...
`npm run ci` runs lint, TypeScript checking, deterministic fixture generation, the benchmark, a production build, 130 unit/integration tests, one real-Chromium read-only acceptance test, and coverage thresholds.
...
- **131 / 131 automated tests** — 130 unit/integration tests plus 1 real-Chromium read-only acceptance test
