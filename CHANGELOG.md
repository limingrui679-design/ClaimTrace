...
- corrected the local-data disclosure to state that AuditBundle exports may embed up to 500 KB of raw data per snapshot for self-contained verification, and added a compiled-interface regression check for that boundary;
